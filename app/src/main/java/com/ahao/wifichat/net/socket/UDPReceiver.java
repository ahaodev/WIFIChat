...
//    private final User me;
     ...
     */
    public UDPReceiver(final Userinfo userinfo, final ErrorHandler errorHandler) {
        Validate.notNull(userinfo, "userinfo can not be null");
